...
ifeq ($(BUILD), Debug)
	CXXFLAGS += -O2 -g -fdiagnostics-color=always -no-pie
...
ifeq ($(SFML), INC)
	LIB_PATH += C:\SFML-2.5
	LIB_DEPEND += sfml-graphics sfml-window sfml-system sfml-audio
endif
